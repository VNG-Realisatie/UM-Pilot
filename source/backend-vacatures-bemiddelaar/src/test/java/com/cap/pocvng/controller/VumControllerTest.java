...
class VumControllerTest {
    ...
    private static VacatureMatchesCallbackRequest callbackRequest;

    @BeforeEach
    void setUp() {
        try {
            callbackRequest = objectMapper.readValue(new File(PATH, "vacature-matches-callback-request.json"),
