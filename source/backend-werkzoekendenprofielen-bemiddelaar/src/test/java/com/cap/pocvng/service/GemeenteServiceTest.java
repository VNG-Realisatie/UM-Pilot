...
class GemeenteServiceTest {
    ...
    @Test
    void makeRequestDetailWerkzoekendeSuccess() {
        ...
        assertThat(service.makeRequestDetailWerkzoekende(VRAAG_ID, VUM_ID, OIN)).isEqualTo(responseToDetailRequest.getWerkzoekende());
    }
