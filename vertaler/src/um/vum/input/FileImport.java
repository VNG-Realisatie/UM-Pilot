...
public class FileImport implements Importer{
	...
	public WerkzoekendeProfiel[] read(String filename) {
		...
		try {
		    ...
		    // lees regel voor regel tot het einde vanhet bestand is bereikt
	...
	private WerkzoekendeProfiel placeInObject(String[] elements) {
		...
		cp.setNaamContactpersoonAfdeling(elements[1]);
		cp.setTelefoonnummer(elements[2]);
		cp.setEmailadres(elements[3]);
