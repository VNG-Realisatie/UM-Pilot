...
public class WerkzoekendeProfiel implements java.io.Serializable {
	...
	// Toegevoegd ivm Wbp
	private boolean toestemmingTotDelenProfiel;
	
	
	public WerkzoekendeProfiel() {
		// Om er zeker van te zijn dat er expliciet toestemming is gegeven tot delen
		toestemmingTotDelenProfiel = false; 
	}
	...
	public boolean isToestemmingTotDelenProfiel() {
		return toestemmingTotDelenProfiel;
	}
	
	/**
	 * @param toestemmingTotDelenProfiel
	 * verplicht: Een profieleigenaar moet toestemming hebben gegeven voor het delen van het profiel 
	 */
	public void setToestemmingTotDelenProfiel(boolean toestemmingTotDelenProfiel) {
		this.toestemmingTotDelenProfiel = toestemmingTotDelenProfiel;
	}
	 ...
	 * TODO klopt dit object bemiddelingsberoepen?
	 */
